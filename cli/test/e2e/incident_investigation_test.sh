...
ADD_ALERTS_JSON=$($CLI block get -o json --doc "$DOC_ID" --block-number 1)
...
ADD_MD_JSON=$($CLI block get -o json --doc "$DOC_ID" --block-number "$MD_BLOCK_NUM")
...
UPDATE_ALERTS_JSON=$($CLI block get -o json --doc "$DOC_ID" --block-number 1)
...
UPDATE_MD_JSON=$($CLI block get -o json --doc "$DOC_ID" --block-number "$MD_BLOCK_NUM")
...
LIST_BLOCKS_OUT=$($CLI block list --doc "$DOC_ID")
...
HISTORY_JSON=$($CLI block history -o json --doc "$DOC_ID" --block-number 1)
